// TypeScript test script for the Lazada scraper
import { LazadaScraper } from './src/services/scrapers/lazada-scraper';
import { SearchFilters } from './src/services/shopping-apis';
