...
export function DashboardFeatureCards() {
  const features = [
    {
      icon: <Search className="h-6 w-6 text-pink-400" />,
      title: "Cross-Platform Search",
      description: "Search across Shopee, Lazada, Zalora, and Shein to find the best deals on your favorite products.",
      linkHref: "/app",
      linkText: "Search now"
    },
    {
...
export function ProfileFeatureCards() {
  const features = [
    {
    ...
    },
    {
      ...
      description: "View insights about your shopping habits, searches, and interactions.",
      linkHref: "/app/analytics",
      linkText: "View analytics"
    },
    {
      icon: <ShoppingBag className="h-6 w-6 text-pink-400" />,
      title: "Saved Products",
      description: "Access your saved products and wishlists across all platforms.",
      linkHref: "/app/wishlist",
      linkText: "View saved items"
    },
    {
      icon: <Smartphone className="h-6 w-6 text-pink-400" />,
      title: "Mobile Experience",
      description: "Enjoy the same great experience on your mobile device with our responsive design.",
      linkHref: "/app",
      linkText: "Try mobile view"
    }
  ];
